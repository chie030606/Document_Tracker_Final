...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Insert request
        $stmt = mysqli_prepare($conn, "INSERT INTO requests (tracking_id, full_name, doc_type, submission_date, phone, email, purpose, priority, notes) VALUES (?,?,?,?,?,?,?,?,?)");
        mysqli_stmt_bind_param($stmt, 'sssssssss', $tracking, $fullName, $docType, $subDate, $phone, $email, $purpose, $priority, $notes);
...
<div class="layout">
  ...
  <nav class="sidebar">
    ...
    <a class="nav-item active" href="#"><span class="nav-icon">➕</span> Add Request</a>
