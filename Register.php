    ...
    <main class="auth-wrap" aria-labelledby="reg-title">
      <div class="auth-card" role="main">
        <div class="auth-brand">
          <div class="brand-icon" aria-hidden="true">
            ...
            <svg width="36" height="36" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9l-6-6z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M14 3v6h6" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        ...
        <form class="auth-form" action="" method="post" autocomplete="off" novalidate>
          ...
          <p class="small muted center">Already have an account? <a href="index.php" class="link">Sign in</a></p>
        </form>
      </div>
    </main>
  </div>
