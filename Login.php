        ...
        <div class="auth-card" role="main" aria-labelledby="site-title">
            <div class="auth-brand">
                <div class="brand-icon" aria-hidden="true">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9l-6-6z" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
                        <path d="M14 3v6h6" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
                    </svg>
                </div>
            ...
            <form class="auth-form" action="" method="post" autocomplete="off" novalidate>
                ...
                <div class="form-row space-between">
                    ...
                    <a class="link-muted" href="forgot.php">Forgot password?</a>
                </div>
