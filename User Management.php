...
<header class="topbar">
  ...
  <div class="topbar-right">
    ...
    <div class="user-chip">
      <div class="avatar" style="background:linear-gradient(135deg,#2563eb,#8b5cf6)">MS</div>
      <div class="user-info">
...
<div class="layout">
  ...
  <nav class="sidebar">
    ...
    <a class="nav-item active" href="#"><span class="nav-icon">👥</span> User Management</a>
  ...
  <main class="main">
    ...
    <div class="stats-row">
      ...
      <div class="stat-card" style="--accent:#10b981">
        <div>
          ...
          <div class="stat-num" id="statActive">5</div>
        </div>
      ...
      <div class="stat-card" style="--accent:#8b5cf6">
        <div>
          ...
          <div class="stat-num" id="statAdmins">1</div>
        </div>
    ...
    <div class="table-card">
      <div class="table-header">
        <div class="table-title">All Users <span class="record-badge" id="recordBadge">6</span></div>
      </div>
      <table>
        <thead>
          <tr>
  ...
  <div class="modal">
    ...
    <div class="modal-grid">
      ...
      <div class="modal-field full">
        ...
        <input type="text" id="mDept" placeholder="e.g. Civil Registry">
      </div>
    </div>
...
<script>
  ...
  // ── Dataset ──
  let users = [
    { id:1, name:'Maria Santisima', email:'maria.santisima@docutrack.com', role:'Administrator', status:'Active',   requests:45, dept:'Administration' },
    { id:2, name:'John Doe',        email:'john.doe@docutrack.com',        role:'Staff',          status:'Active',   requests:32, dept:'Civil Registry' },
    { id:3, name:'Jane Smith',      email:'jane.smith@docutrack.com',      role:'Staff',          status:'Active',   requests:28, dept:'Business Permits' },
    { id:4, name:'Bob Johnson',     email:'bob.johnson@docutrack.com',     role:'Viewer',         status:'Active',   requests:15, dept:'Finance' },
    { id:5, name:'Alice Brown',     email:'alice.brown@docutrack.com',     role:'Staff',          status:'Active',   requests:21, dept:'Civil Registry' },
    { id:6, name:'Charlie Davis',   email:'charlie.davis@docutrack.com',   role:'Viewer',         status:'Inactive', requests:7,  dept:'IT Support' },
  ];
  let nextId = 7;
  let editingId = null;
  let deletingId = null;
  ...
  function openAddModal() {
    ...
    ['mFirstName','mLastName','mEmail','mDept'].forEach(id => document.getElementById(id).value = '');
  ...
  function saveUser() {
    ...
    if (editingId) {
      ...
      u.email = email; u.role = role; u.status = status; u.dept = dept;
      showToast(`${u.name} updated successfully`);
    } else {
      users.push({ id: nextId++, name: `${fname} ${lname}`.trim(), email, role, status, requests: 0, dept });
